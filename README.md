...
## Research infrastructure for stronger lower bounds
...
of sets. It also defines the proposed infinitely-often
...
These modules are structural research tools. They do **not** claim or assume
the proposed super-log-log lower bound, which remains open.
...
| `AntichainOfGivenSize.LowerBound.VennProfiles`, `.ThresholdFiltration` | Exact Venn-profile normal form, the explicitly labeled open power target, and exact threshold-complex filtration and moment identities |
